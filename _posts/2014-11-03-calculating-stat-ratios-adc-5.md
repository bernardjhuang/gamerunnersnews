...
If There Are Ninjas...
If ther are ninjas, we simply do not buy Bloodthirster (what's the point of Life Steal if we are Assassinated?). Instead we buy a defensive item in its slot. Here's an example build:
